export default [
        ...
        form: [
            ...
            },
            {
                ...
                options: [
                    ...
                    'Informative and Implementations',
                    'Some Informative Post',
                    ...
                    'UPSC Study Materials and Resources',
                    'UPSC Interview Experiences',
                    'UPSC Exam Strategies and Techniques',
                    'UPSC Topic Wise Insights',
                    'UPSC Polity Insights',
                    'UPSC History Insights',
                    'UPSC Geography Insights',
                    'UPSC Economics Insights',
                    'UPSC Science and Technology Insights',
                    'UPSC Environment and Ecology Insights',
                    'UPSC Current Affairs Insights'
                ]
            },
            {
    ...
    {
        name: 'LinkedIn Post Idea Generator',
        desc: 'An AI tool that generates creative and engaging LinkedIn post ideas to boost your professional presence and network growth.',
        icon: 'https://cdn-icons-png.flaticon.com/128/3536/3536505.png',
        category: 'Professional Networking',
        slug: 'linkedin-post-idea-generator',
        aiPrompt: 'Generate 5 creative LinkedIn post ideas based on the given information. Each idea should include: 1) A catchy headline 2) A brief outline of the post content 3) Specify the target audience 4) Suggested hashtags 5) Engagement prompt (e.g., question to ask followers). Ensure ideas are tailored to the specified audience and post type. Include relevant emojis to increase engagement while maintaining professionalism.',
        form: [
            {
                label: 'What\'s your professional field or industry?',
                field: 'input',
                name: 'industry',
                required: true
            },
            ...
            {
                label: 'Any specific topics or themes you want to focus on? (Optional)',
                field: 'textarea',
                name: 'topics'
            }
        ]
